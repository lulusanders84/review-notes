...
const ServiceTypeInput = (props) => {
  ...
  return (
    <ReactSelectSingle id="serviceType" placeholder="" label="Service Type" updateValue={props.handleInputs} suggestions={suggestions} value={{value:props.values.type, label: props.values.type}} />
  )
}
